...
class AppraisalCustom(models.Model):
    ...
    score_perc = fields.Float(string='Score Percantage', track_visibility='always', compute='calculate_score')
    extra_point = fields.Float(string='Extra Points', track_visibility='always')
    total_score = fields.Float(string='Total Score', track_visibility='always', compute='calculate_score')
